<template>
  <div class="container mx-auto px-8 py-10">
    ...
    <h2 class="text-2xl mb-4">Privacy Policy</h2>
    <p>
      Raquib-ul Alam built the Art Guide app as a Freemium app. This SERVICE is
      provided by Raquib-ul Alam at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Art Guide unless otherwise
      defined in this Privacy Policy.
    </p>
    <p class="text-lg mt-4 mb-1">
      <strong>Information Collection and Use</strong>
    </p>
    <p>
      For a better experience, while using our Service, I may require you to
      provide us with certain personally identifiable information, including but
      not limited to first name, last name. The information that I request will
    ...
    <p class="text-lg mt-4 mb-1"><strong>Log Data</strong></p>
    <p>
    ...
    <p class="text-lg mt-4 mb-1"><strong>Cookies</strong></p>
    <p>
    ...
    <p class="text-lg mt-4 mb-1"><strong>Service Providers</strong></p>
    <p>
    ...
    <p class="text-lg mt-4 mb-1"><strong>Security</strong></p>
    <p>
    ...
    <p class="text-lg mt-4 mb-1"><strong>Links to Other Sites</strong></p>
    <p>
    ...
    <p class="text-lg mt-4 mb-1"><strong>Children’s Privacy</strong></p>
    <p>
    ...
    <p class="text-lg mt-4 mb-1"><strong>Contact Us</strong></p>
    <p>
