<template>
  <div class="container mx-auto px-8 py-10">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Raquib-ul
      Alam.
    </p>
    <p>
      Raquib-ul Alam is committed to ensuring that the app is as useful and
    ...
    <p>
      The Art Guide app stores and processes personal data that you have
      ...
      features and it could mean that the Art Guide app won't work properly or
      at all.
    </p>
    <div>
      <p>
      ...
      <ul>
        ...
        <li>
          <NuxtLink
            class="text-blue-700 hover:underline"
            to="https://firebase.google.com/terms/analytics"
            target="_blank"
            rel="noopener noreferrer"
            >• Google Analytics for Firebase</NuxtLink
          >
        </li>
        <li>
          <NuxtLink
            ...
            target="_blank"
            rel="noopener noreferrer"
            >• Firebase Crashlytics</NuxtLink
          >
        </li>
      </ul>
    </div>
    <p>
      You should be aware that there are certain things that Raquib-ul Alam will
      ...
      provided by your mobile network provider, but Raquib-ul Alam cannot take
    ...
    <p>
      Along the same lines, Raquib-ul Alam cannot always take responsibility for
      ...
      Service, Raquib-ul Alam cannot accept responsibility.
    </p>
    <p>
      With respect to Raquib-ul Alam's responsibility for your use of the app,
      ...
      available to you. Raquib-ul Alam accepts no liability for any loss, direct
    ...
    <p>
      ...
      Raquib-ul Alam does not promise that it will always update the app so that
    ...
    <h3 class="text-lg font-semibold">Changes to This Terms and Conditions</h3>
    <p>
    ...
    <p>These terms and conditions are effective as of 2021-08-02</p>
    ...
    <p>
      ...
      <NuxtLink
        class="text-blue-700 hover:underline"
        to="alam.kanak@gmail.com"
        target="_blank"
        >alam.kanak@gmail.com</NuxtLink
      >.
    </p>
  </div>
</template>
